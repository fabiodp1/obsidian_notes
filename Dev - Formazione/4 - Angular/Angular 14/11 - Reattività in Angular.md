...
La decisione di eseguire `NgDoCheck` anche se un componente è `OnPush` spesso causa confusione. Ciò è intenzionale sapendo che viene eseguito come parte del controllo del componente principale.
